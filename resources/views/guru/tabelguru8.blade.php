...
<section class="guru1" id="guru1">
  ...
  <a href="<?= url("tabelguru7")?>"><button type="submit" class="green margin-right">Previous</button></a>
  <a href="<?= url("tabelguru1")?>"><button type="submit" class="magenta">Next</button></a>
</div>
