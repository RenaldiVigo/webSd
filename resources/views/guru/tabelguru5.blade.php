...
<section class="guru1" id="guru1">
  ...
  <a href="<?= url("tabelguru4")?>"><button type="submit" class="green margin-right">Previous</button></a>
  <a href="<?= url("tabelguru6")?>"><button type="submit" class="magenta">Next</button></a>
</div>
