...
<section class="guru1" id="guru1">
  ...
  <table class="table table-bordered">
    <tbody>
      ...
      <tr>
         <th>Jabatan :</th>
         <td>Guru Kelas dan Kepala Sekolah</td>
      </tr>
      <tr>
  ...
  <a href="<?= url("tabelguru1")?>"><button type="submit" class="green margin-right">Previous</button></a>
  <a href="<?= url("tabelguru3")?>"><button type="submit" class="magenta">Next</button></a>
</div>
