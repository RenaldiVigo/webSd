...
<div class="flex-parent jc-center">
  <a href="<?= url("tabelguru8")?>"><button type="submit" class="green margin-right">Previous</button></a>
  <a href="<?= url("tabelguru2")?>"><button type="submit" class="magenta">Next</button></a>
</div>
